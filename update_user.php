...
<head>
    ...
    <title>CERTBY - Kullanıcı Bilgilerini Güncelle</title>
    <style>
...
<body>
    ...
    <div class="container">
        <header class="header">
            <h1 class="header-title">Kullanıcı Bilgilerini Güncelle</h1>
        </header>
        
        <form action="update_user_process.php" method="POST" onsubmit="return validatePassword()">
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    <div class="form-field">
                        ...
                        <input type="text" id="username" name="username" required value="denetci1">
                    </div>
                    <div class="form-field">
                        <label for="name" class="required">Ad Soyad</label>
                        <input type="text" id="name" name="name" required value="Denetçi A.">
                    </div>
                    <div class="form-field">
                        <label for="email" class="required">E-posta</label>
                        <input type="email" id="email" name="email" required value="denetci@certby.com">
                    </div>
                    <div class="form-field">
            ...
            <div class="form-section">
                <h2 class="form-section-title">Şifre Güncelleme</h2>
                <div class="form-grid">
                    <div class="form-field">
                        <label for="password">Yeni Şifre</label>
                        <input type="password" id="password" name="password" placeholder="Sadece değiştirmek istiyorsanız girin">
                    </div>
                    <div class="form-field">
            ...
            <div class="button-group">
                ...
                <button type="submit" class="action-button update">Bilgileri Güncelle</button>
            </div>
        </form>
    </div>
